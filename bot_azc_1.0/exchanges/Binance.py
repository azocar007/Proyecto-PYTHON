...
if __name__ == "__main__":
    ...
    test_api_key = os.getenv("BINANCE_TESTNET_API_KEY")
    test_api_secret = os.getenv("BINANCE_TESTNET_API_SECRET")
    ...
    if not test_api_key or not test_api_secret:
        ...
        config_binance_test = {
            ...
            "modo_gestion_de_ordenes": "DINAMICO", # "DINAMICO", "REENTRADAS", "SNOW BALL", "GAFAS"
            ...
            "precio_entrada_long": 58000,  # AJUSTAR: Disparar LONG si precio <= este valor
            "precio_entrada_short": 62000, # AJUSTAR: Disparar SHORT si precio >= este valor
