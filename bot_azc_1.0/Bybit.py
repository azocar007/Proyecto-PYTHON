...
class Bybit:
    def __init__(self, dict_config: dict):
        ...
        self.api_key = str(dict_config.get("api_key", "X2ubLN641kBWsqb0mm")) 
        self.api_secret = str(dict_config.get("api_secret", "rU5QWC2vUaOfpg9BPbdPZ5EPwcbNenLKr7tc")) 
...
if __name__ == "__main__":
    ...
    config_test = {
        ...
        "testnet": True, 
        "symbol": "BTC", # Ej: "BTC", "ETH", "SOL" (sin "-USDT")
        ...
        "precio_entrada_long": 50000,  # Ej: Si BTCUSDT está a 60000, poner 59000 para probar entrada LONG.
        "precio_entrada_short": 70000, # Ej: Si BTCUSDT está a 60000, poner 61000 para probar entrada SHORT.
